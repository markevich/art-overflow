...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Art Overflow', 'Admin']
  ...
  # config.excluded_models = ['Drawing', 'Invite', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Drawing', 'Invite', 'User']
  ...
  # config.model 'Drawing' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your drawing.rb model definition

...
SimpleNavigation::Configuration.run do |navigation|
  ...
  navigation.items do |primary|
    ...
    #
    primary.item :profile, 'Личные данные', edit_user_path(current_user)
    primary.item :profile, 'Пароль', edit_user_passwords_path
    primary.item :profile, 'Уведомления', notification_settings_path

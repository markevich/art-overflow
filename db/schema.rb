...
ActiveRecord::Schema.define(version: 20140831123115) do
  ...
  add_index "emotions", ["picture_id"], name: "index_emotions_on_picture_id", using: :btree
  add_index "emotions", ["type"], name: "index_emotions_on_type", using: :btree
  ...
  create_table "pictures", force: true do |t|
    ...
    t.string   "graphics_type"
  end

  add_index "pictures", ["album_id"], name: "index_pictures_on_album_id", using: :btree
  add_index "pictures", ["graphics_type"], name: "index_pictures_on_graphics_type", using: :btree

...
ActiveRecord::Schema.define(:version => 20130125214815) do
  ...
  create_table "drawing_categories", :force => true do |t|
    t.string   "name"
    t.string   "slug"
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
  ...
  add_index "drawing_categories", ["ancestry"], :name => "index_drawing_categories_on_ancestry"
  add_index "drawing_categories", ["slug"], :name => "index_drawing_categories_on_slug", :unique => true
  ...
  create_table "views", :force => true do |t|
    ...
    t.datetime "past_time_viewed", :default => '2013-01-16 18:29:19'
    t.datetime "created_at",                                          :null => false
    t.datetime "updated_at",                                          :null => false
  end
